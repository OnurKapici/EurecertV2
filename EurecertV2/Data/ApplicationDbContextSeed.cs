...
namespace EurecertV2.Data
{
    public static class ApplicationDbContextSeed
    {
        ...
        public static void AddCountry(ApplicationDbContext context)
        {
            ...
            newCountries.Add(new Country() { Name = "Almenya" });
        ...
        public static void AddCity(ApplicationDbContext context)
        {
            ...
            newCities.Add(new City() { CountryId = 1, Name = "02 Adiyaman" });
            newCities.Add(new City() { CountryId = 1, Name = "03 Afyon" });
            newCities.Add(new City() { CountryId = 1, Name = "04 Agri" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "09 Aydin" });
            newCities.Add(new City() { CountryId = 1, Name = "10 Balikesir" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "34 Istanbul" });
            newCities.Add(new City() { CountryId = 1, Name = "35 Izmir" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "39 Kirklareli" });
            newCities.Add(new City() { CountryId = 1, Name = "40 Kirsehir" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "46 K.Maras" });
            newCities.Add(new City() { CountryId = 1, Name = "47 Mardin" });
            newCities.Add(new City() { CountryId = 1, Name = "48 Mugla" });
            newCities.Add(new City() { CountryId = 1, Name = "49 Mus" });
            newCities.Add(new City() { CountryId = 1, Name = "50 Nevsehir" });
            newCities.Add(new City() { CountryId = 1, Name = "51 Nigde" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "59 Tekirdag" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "63 Sanliurfa" });
            newCities.Add(new City() { CountryId = 1, Name = "64 Usak" });
            ...
            newCities.Add(new City() { CountryId = 1, Name = "71 Kirikkale" });
            newCities.Add(new City() { CountryId = 1, Name = "72 Batman" });
            newCities.Add(new City() { CountryId = 1, Name = "73 Sirnak" });
            newCities.Add(new City() { CountryId = 1, Name = "74 Bartin" });
            newCities.Add(new City() { CountryId = 1, Name = "75 Ardahan" });
            newCities.Add(new City() { CountryId = 1, Name = "76 Igdir" });
